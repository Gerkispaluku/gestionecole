...
$fonction_addopt = NULL; // Initialize page object first

class cfonction_addopt extends cfonction {
	...
	// Page object name
	var $PageObjName = 'fonction_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_NomFoction"] = $this->NomFoction->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadFormValues() {
		...
		if (!$this->NomFoction->FldIsDetailKey) {
			$this->NomFoction->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_NomFoction")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->NomFoction->CurrentValue = ew_ConvertToUtf8($this->NomFoction->FormValue);
	}
...
// Create page object
if (!isset($fonction_addopt)) $fonction_addopt = new cfonction_addopt();

// Page init
$fonction_addopt->Page_Init();

// Page main
$fonction_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fonction_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = ffonctionaddopt = new ew_Form("ffonctionaddopt", "addopt");

// Validate form
ffonctionaddopt.Validate = function() {
...
ffonctionaddopt.Form_CustomValidate = 
...
ffonctionaddopt.ValidateRequired = true;
<?php } else { ?>
ffonctionaddopt.ValidateRequired = false; 
<?php } ?>
...
<?php
$fonction_addopt->ShowMessage();
?>
<form name="ffonctionaddopt" id="ffonctionaddopt" class="ewForm form-horizontal" action="fonctionaddopt.php" method="post">
<?php if ($fonction_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $fonction_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="fonction">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($fonction->NomFoction->Visible) { // NomFoction ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_NomFoction"><?php echo $fonction->NomFoction->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php
$fonction_addopt->Page_Terminate();
?>
