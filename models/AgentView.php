...
class AgentView extends Agent
{
    ...
    // CSS class/style
    public $CurrentPageName = "AgentView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("IdAgent") ?? Route("IdAgent")) !== null) {
            ...
            $returnUrl = "AgentList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AgentList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
