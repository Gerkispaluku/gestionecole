...
class EleveView extends Eleve
{
    ...
    // CSS class/style
    public $CurrentPageName = "EleveView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("IdEleve") ?? Route("IdEleve")) !== null) {
            ...
            $returnUrl = "EleveList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EleveList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
