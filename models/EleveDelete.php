 ...
 * Page class
 */
class EleveDelete extends Eleve
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EleveDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EleveDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EleveList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EleveList"); // Return to list
                return;
            }
        }
