 ...
 * Page class
 */
class FonctionView extends Fonction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FonctionView";
    ...
    // CSS class/style
    public $CurrentPageName = "FonctionView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("IdFonction") ?? Route("IdFonction")) !== null) {
            $this->RecKey["IdFonction"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("IdFonction") ?? Route("IdFonction")) !== null) {
            ...
            $returnUrl = "FonctionList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FonctionList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
