 ...
 * Page class
 */
class ClasseView extends Classe
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "ClasseView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("IdClasse") ?? Route("IdClasse")) !== null) {
            ...
            $returnUrl = "ClasseList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ClasseList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
