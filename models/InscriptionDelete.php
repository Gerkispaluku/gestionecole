 ...
 * Page class
 */
class InscriptionDelete extends Inscription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InscriptionDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "InscriptionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("InscriptionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("InscriptionList"); // Return to list
                return;
            }
        }
