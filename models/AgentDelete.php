 ...
 * Page class
 */
class AgentDelete extends Agent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AgentDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AgentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AgentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AgentList"); // Return to list
                return;
            }
        }
