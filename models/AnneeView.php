...
class AnneeView extends Annee
{
    ...
    // CSS class/style
    public $CurrentPageName = "AnneeView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("IdAnnee") ?? Route("IdAnnee")) !== null) {
            ...
            $returnUrl = "AnneeList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AnneeList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
