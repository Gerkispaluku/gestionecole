 ...
 * Page class
 */
class InscriptionView extends Inscription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InscriptionView";
    ...
    // CSS class/style
    public $CurrentPageName = "InscriptionView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("IdInscription") ?? Route("IdInscription")) !== null) {
            $this->RecKey["IdInscription"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        } elseif (Post("IdInscription") !== null) {
            $this->IdInscription->setFormValue(Post("IdInscription"));
            $this->RecKey["IdInscription"] = $this->IdInscription->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->IdInscription->setQueryStringValue($keyValue);
            $this->RecKey["IdInscription"] = $this->IdInscription->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "InscriptionList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "InscriptionList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
