 ...
 * Page class
 */
class InscriptionEdit extends Inscription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InscriptionEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "InscriptionEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("IdInscription") ?? Key(0) ?? Route(2)) !== null) {
                $this->IdInscription->setQueryStringValue($keyValue);
                $this->IdInscription->setOldValue($this->IdInscription->QueryStringValue);
            } elseif (Post("IdInscription") !== null) {
                $this->IdInscription->setFormValue(Post("IdInscription"));
                $this->IdInscription->setOldValue($this->IdInscription->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("IdInscription") ?? Route("IdInscription")) !== null) {
                    ...
                    $this->IdInscription->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->IdInscription->IsDetailKey) {
            $this->IdInscription->setFormValue($val);
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
        if ($this->IdInscription->Required) {
            if (!$this->IdInscription->IsDetailKey && EmptyValue($this->IdInscription->FormValue)) {
                $this->IdInscription->addErrorMessage(str_replace("%s", $this->IdInscription->caption(), $this->IdInscription->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        // IdEleve
        $this->IdEleve->setDbValueDef($rsnew, $this->IdEleve->CurrentValue, $this->IdEleve->ReadOnly);

        // IdClasse
        $this->IdClasse->setDbValueDef($rsnew, $this->IdClasse->CurrentValue, $this->IdClasse->ReadOnly);

        // IdAnnee
        $this->IdAnnee->setDbValueDef($rsnew, $this->IdAnnee->CurrentValue, $this->IdAnnee->ReadOnly);
