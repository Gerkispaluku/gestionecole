...
$Page->showMessage();
?>
<form name="finscriptiondelete" id="finscriptiondelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php if ($Page->IdInscription->Visible) { // IdInscription ?>
        <th class="<?= $Page->IdInscription->headerCellClass() ?>"><span id="elh_inscription_IdInscription" class="inscription_IdInscription"><?= $Page->IdInscription->caption() ?></span></th>
<?php } ?>
<?php if ($Page->IdEleve->Visible) { // IdEleve ?>
        <th class="<?= $Page->IdEleve->headerCellClass() ?>"><span id="elh_inscription_IdEleve" class="inscription_IdEleve"><?= $Page->IdEleve->caption() ?></span></th>
<?php } ?>
<?php if ($Page->IdClasse->Visible) { // IdClasse ?>
        <th class="<?= $Page->IdClasse->headerCellClass() ?>"><span id="elh_inscription_IdClasse" class="inscription_IdClasse"><?= $Page->IdClasse->caption() ?></span></th>
<?php } ?>
<?php if ($Page->IdAnnee->Visible) { // IdAnnee ?>
        <th class="<?= $Page->IdAnnee->headerCellClass() ?>"><span id="elh_inscription_IdAnnee" class="inscription_IdAnnee"><?= $Page->IdAnnee->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php if ($Page->IdInscription->Visible) { // IdInscription ?>
        <td<?= $Page->IdInscription->cellAttributes() ?>>
