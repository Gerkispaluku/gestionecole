...
<link rel="stylesheet" href="<?= $basePath ?>css/select2.min.css?v=19.9.2">
<link rel="stylesheet" href="<?= $basePath ?>css/select2-bootstrap5.min.css?v=19.9.2">
<link rel="stylesheet" href="<?= $basePath ?>css/sweetalert2.min.css?v=19.9.2">
<link rel="stylesheet" href="<?= $basePath ?><?= Config("FONT_AWESOME_STYLESHEET") ?>?v=19.9.2">
<link rel="stylesheet" href="<?= $basePath ?>css/OverlayScrollbars.min.css?v=19.9.2">
<link rel="stylesheet" href="<?= $basePath ?>adminlte3/css/<?= CssFile("adminlte.css") ?>?v=19.9.2">
<link rel="stylesheet" href="<?= $basePath ?><?= CssFile(Config("PROJECT_STYLESHEET_FILENAME")) ?>?v=19.9.2">
<script data-pace-options='<?= JsonEncode(Config("PACE_OPTIONS")) ?>' src="<?= $basePath ?>js/pace.js?v=19.9.2"></script><!-- Single quotes for data-pace-options -->
<script src="<?= $basePath ?>js/element-internals-polyfill.min.js?v=19.9.2"></script>
<script src="<?= $basePath ?>js/ewcore.min.js?v=19.9.2"></script>
<script>
var $rowindex$ = null;
Object.assign(ew, <?= JsonEncode(ConfigClientVars()) ?>, <?= JsonEncode(GlobalClientVars()) ?>);
loadjs(ew.PATH_BASE + "jquery/jquery.min.js?v=19.9.2", "jquery");
loadjs(ew.PATH_BASE + "js/popper.min.js?v=19.9.2", "popper");
loadjs(ew.PATH_BASE + "js/luxon.min.js?v=19.9.2", "luxon");
loadjs([
    ew.PATH_BASE + "js/mobile-detect.min.js?v=19.9.2",
    ew.PATH_BASE + "js/purify.min.js?v=19.9.2",
    ew.PATH_BASE + "js/cropper.min.js?v=19.9.2",
    ew.PATH_BASE + "jquery/load-image.all.min.js?v=19.9.2"
], "others");
loadjs(ew.PATH_BASE + "js/sweetalert2.min.js?v=19.9.2", "swal");
<?= $Language->toJson() ?>
ew.vars = <?= JsonEncode(GetClientVar()) ?>;
ew.ready(["wrapper", "jquery"], ew.PATH_BASE + "jquery/jsrender.min.js?v=19.9.2", "jsrender", ew.renderJsTemplates);
ew.ready("jsrender", ew.PATH_BASE + "jquery/jquery.overlayScrollbars.min.js?v=19.9.2", "scrollbars"); // Init sidebar scrollbars after rendering menu
ew.ready("jquery", ew.PATH_BASE + "jquery/jquery-ui.min.js?v=19.9.2", "widget");
</script>
<?php include_once $RELATIVE_PATH . "views/menu.php"; ?>
<script>
var cssfiles = [
    ew.PATH_BASE + "css/jquery.fileupload.css?v=19.9.2",
    ew.PATH_BASE + "css/jquery.fileupload-ui.css?v=19.9.2",
    ew.PATH_BASE + "css/cropper.min.css?v=19.9.2"
];
cssfiles.push(ew.PATH_BASE + "colorbox/colorbox.css?v=19.9.2");
loadjs(cssfiles, "css");
var cssjs = [];
<?php foreach (array_merge(Config("STYLESHEET_FILES"), Config("JAVASCRIPT_FILES")) as $file) { // External Stylesheets and JavaScripts ?>
cssjs.push("<?= (IsRemote($file) ? "" : BasePath(true)) . $file ?>?v=19.9.2");
<?php } ?>
var jqueryjs = [
    ew.PATH_BASE + "jquery/select2.full.min.js?v=19.9.2",
    ew.PATH_BASE + "jquery/jqueryfileupload.min.js?v=19.9.2",
    ew.PATH_BASE + "jquery/typeahead.jquery.min.js?v=19.9.2"
];
jqueryjs.push(ew.PATH_BASE + "colorbox/jquery.colorbox.min.js?v=19.9.2");
jqueryjs.push(ew.PATH_BASE + "js/pdfobject.min.js?v=19.9.2");
ew.ready(["jquery", "dom", "popper"], ew.PATH_BASE + "bootstrap5/js/bootstrap.min.js?v=19.9.2", "bootstrap"); // Bootstrap
ew.ready("bootstrap", ew.PATH_BASE + "adminlte3/js/adminlte.min.js?v=19.9.2", "adminlte"); // AdminLTE (After Bootstrap)
ew.ready(["jquery", "widget"], [jqueryjs], "jqueryjs");
ew.ready(["bootstrap", "adminlte", "jqueryjs", "scrollbars", "luxon", "others"], ew.PATH_BASE + "js/ew.min.js?v=19.9.2", "makerjs");
ew.ready("makerjs", [
    cssjs,
    ew.PATH_BASE + "js/userfn.js?v=19.9.2",
    ew.PATH_BASE + "js/userevent.js?v=19.9.2"
], "head");
</script>
<script>
loadjs(ew.PATH_BASE + "css/<?= CssFile("tempus-dominus.css", false) ?>?v=19.9.0");
ew.ready("head", [
    ew.PATH_BASE + "js/tempus-dominus.min.js?v=19.9.0",
    ew.PATH_BASE + "js/ewdatetimepicker.min.js?v=19.9.0"
], "datetimepicker");
</script>
<!-- Navbar -->
...
<meta name="generator" content="PHPMaker 2023.9.0">
</head>
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none d-sm-block" href="#" data-ew-action="none">
                    <img src="<?= GetUrl("images/phpmkrlogo2017.png") ?>" alt="" class="brand-image ew-brand-image">
                </a>
            </ul>
            <!-- Right navbar links -->
