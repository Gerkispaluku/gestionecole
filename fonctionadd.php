...
$fonction_add = NULL; // Initialize page object first

class cfonction_add extends cfonction {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["IdFonction"] != "") {
				...
				$this->setKey("IdFonction", $this->IdFonction->CurrentValue); // Set up key
			} else {
				$this->setKey("IdFonction", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("fonctionlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "fonctionview.php")
	...
	function LoadDefaultValues() {
		...
		$this->NomFoction->OldValue = $this->NomFoction->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// NomFoction
		$this->NomFoction->SetDbValueDef($rsnew, $this->NomFoction->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($fonction_add)) $fonction_add = new cfonction_add();

// Page init
$fonction_add->Page_Init();

// Page main
$fonction_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fonction_add->Page_Render();
?>
...
var CurrentForm = ffonctionadd = new ew_Form("ffonctionadd", "add");

// Validate form
ffonctionadd.Validate = function() {
...
ffonctionadd.Form_CustomValidate = 
...
ffonctionadd.ValidateRequired = true;
<?php } else { ?>
ffonctionadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $fonction_add->ShowPageHeader(); ?>
<?php
$fonction_add->ShowMessage();
?>
<form name="ffonctionadd" id="ffonctionadd" class="<?php echo $fonction_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($fonction_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $fonction_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $fonction_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
