...
define("EW_PROJECT_NAME", "Projeget2", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{84EC96E8-6D54-4BAB-B15E-1EA379B0779B}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'JB02t0nDlr1kiwOn', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Projeget2.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "gestionecole", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`agent`", TRUE);
define("EW_USER_NAME_FILTER", "(`MatricAgent` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`IdAgent` = %u)", TRUE);
...
define("EW_USER_PROFILE_RETRY_LOCKOUT", 2, TRUE);
