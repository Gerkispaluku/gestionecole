...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "19.9.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "gestion_ECOLE"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{210BB35D-0141-4761-AC04-31A7CA7DF2C3}"); // Project ID
