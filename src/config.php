...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'eSgYsdd39uZGnKr4', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/gestion_ECOLE.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\gestion_ECOLE\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\gestion_ECOLE\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-210bb35d-0141-4761-ac04-31a7ca7df2c3", // Export folder
    ...
    "UPLOAD_DEST_PATH" => "", // Upload destination path (relative to app root)
