...
function GetMultiSearchSqlFilter($fldExpression, $fldOpr, $fldVal, $dbid, $sep)
{
    ...
    $sql .= $fldExpression . LikeOrNotLike($likeOpr, QuotedValue($fldVal . $sep, DATATYPE_STRING, $dbid, "STARTS WITH"), $dbid) . " " . $cond . " " .
        $fldExpression . LikeOrNotLike($likeOpr, QuotedValue($sep . $fldVal . $sep, DATATYPE_STRING, $dbid, "LIKE"), $dbid) . " " . $cond . " " .
        $fldExpression . LikeOrNotLike($likeOpr, QuotedValue($sep . $fldVal, DATATYPE_STRING, $dbid, "ENDS WITH"), $dbid);
    return $sql;
}
