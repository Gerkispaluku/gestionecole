...
$eleve_addopt = NULL; // Initialize page object first

class celeve_addopt extends celeve {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_IdEleve"] = $this->IdEleve->DbValue;
					$row["x_MatricEleve"] = $this->MatricEleve->DbValue;
					$row["x_NomEleve"] = $this->NomEleve->DbValue;
					$row["x_PostnomElve"] = $this->PostnomElve->DbValue;
					$row["x_PrenomEleve"] = $this->PrenomEleve->DbValue;
					$row["x_SexeEleve"] = $this->SexeEleve->DbValue;
					$row["x_DatenaissanceEleve"] = $this->DatenaissanceEleve->DbValue;
					$row["x_LieunaissanceEleve"] = $this->LieunaissanceEleve->DbValue;
					$row["x_NomdupereElve"] = $this->NomdupereElve->DbValue;
					$row["x_NomdelamereEleve"] = $this->NomdelamereEleve->DbValue;
					$row["x_Image_eleve"] = $this->Image_eleve->DbValue;
					$row["x_Description_eleve"] = $this->Description_eleve->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadFormValues() {
		...
		if (!$this->MatricEleve->FldIsDetailKey) {
			$this->MatricEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_MatricEleve")));
		}
		if (!$this->NomEleve->FldIsDetailKey) {
			$this->NomEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_NomEleve")));
		}
		if (!$this->PostnomElve->FldIsDetailKey) {
			$this->PostnomElve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_PostnomElve")));
		}
		if (!$this->PrenomEleve->FldIsDetailKey) {
			$this->PrenomEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_PrenomEleve")));
		}
		if (!$this->SexeEleve->FldIsDetailKey) {
			$this->SexeEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_SexeEleve")));
		}
		if (!$this->DatenaissanceEleve->FldIsDetailKey) {
			$this->DatenaissanceEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_DatenaissanceEleve")));
		...
		if (!$this->LieunaissanceEleve->FldIsDetailKey) {
			$this->LieunaissanceEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_LieunaissanceEleve")));
		}
		if (!$this->NomdupereElve->FldIsDetailKey) {
			$this->NomdupereElve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_NomdupereElve")));
		}
		if (!$this->NomdelamereEleve->FldIsDetailKey) {
			$this->NomdelamereEleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_NomdelamereEleve")));
		}
		if (!$this->Description_eleve->FldIsDetailKey) {
			$this->Description_eleve->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_Description_eleve")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->MatricEleve->CurrentValue = ew_ConvertToUtf8($this->MatricEleve->FormValue);
		$this->NomEleve->CurrentValue = ew_ConvertToUtf8($this->NomEleve->FormValue);
		$this->PostnomElve->CurrentValue = ew_ConvertToUtf8($this->PostnomElve->FormValue);
		$this->PrenomEleve->CurrentValue = ew_ConvertToUtf8($this->PrenomEleve->FormValue);
		$this->SexeEleve->CurrentValue = ew_ConvertToUtf8($this->SexeEleve->FormValue);
		$this->DatenaissanceEleve->CurrentValue = ew_ConvertToUtf8($this->DatenaissanceEleve->FormValue);
		$this->DatenaissanceEleve->CurrentValue = ew_UnFormatDateTime($this->DatenaissanceEleve->CurrentValue, 0);
		$this->LieunaissanceEleve->CurrentValue = ew_ConvertToUtf8($this->LieunaissanceEleve->FormValue);
		$this->NomdupereElve->CurrentValue = ew_ConvertToUtf8($this->NomdupereElve->FormValue);
		$this->NomdelamereEleve->CurrentValue = ew_ConvertToUtf8($this->NomdelamereEleve->FormValue);
		$this->Description_eleve->CurrentValue = ew_ConvertToUtf8($this->Description_eleve->FormValue);
	}
...
// Create page object
if (!isset($eleve_addopt)) $eleve_addopt = new celeve_addopt();

// Page init
$eleve_addopt->Page_Init();

// Page main
$eleve_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$eleve_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = feleveaddopt = new ew_Form("feleveaddopt", "addopt");

// Validate form
feleveaddopt.Validate = function() {
...
feleveaddopt.Form_CustomValidate = 
...
feleveaddopt.ValidateRequired = true;
<?php } else { ?>
feleveaddopt.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
feleveaddopt.Lists["x_SexeEleve"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
feleveaddopt.Lists["x_SexeEleve"].Options = <?php echo json_encode($eleve->SexeEleve->Options()) ?>;
...
<?php
$eleve_addopt->ShowMessage();
?>
<form name="feleveaddopt" id="feleveaddopt" class="ewForm form-horizontal" action="eleveaddopt.php" method="post">
<?php if ($eleve_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $eleve_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="eleve">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($eleve->MatricEleve->Visible) { // MatricEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_MatricEleve"><?php echo $eleve->MatricEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->NomEleve->Visible) { // NomEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_NomEleve"><?php echo $eleve->NomEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->PostnomElve->Visible) { // PostnomElve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_PostnomElve"><?php echo $eleve->PostnomElve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->PrenomEleve->Visible) { // PrenomEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_PrenomEleve"><?php echo $eleve->PrenomEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->SexeEleve->Visible) { // SexeEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel"><?php echo $eleve->SexeEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->DatenaissanceEleve->Visible) { // DatenaissanceEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_DatenaissanceEleve"><?php echo $eleve->DatenaissanceEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<script type="text/javascript">
ew_CreateCalendar("feleveaddopt", "x_DatenaissanceEleve", 0);
</script>
<?php } ?>
</div>
	</div>
...
<?php if ($eleve->LieunaissanceEleve->Visible) { // LieunaissanceEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_LieunaissanceEleve"><?php echo $eleve->LieunaissanceEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->NomdupereElve->Visible) { // NomdupereElve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_NomdupereElve"><?php echo $eleve->NomdupereElve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->NomdelamereEleve->Visible) { // NomdelamereEleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_NomdelamereEleve"><?php echo $eleve->NomdelamereEleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->Image_eleve->Visible) { // Image_eleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel"><?php echo $eleve->Image_eleve->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($eleve->Description_eleve->Visible) { // Description_eleve ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel"><?php echo $eleve->Description_eleve->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-9">
...
<script type="text/javascript">
ew_CreateEditor("feleveaddopt", "x_Description_eleve", 35, 4, <?php echo ($eleve->Description_eleve->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</div>
	</div>
<?php } ?>	
